...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "perm.autoApproveOn": "Auto",
    "perm.autoApproveOff": "Auto",
    "perm.autoApproveOnTip": "Auto-approve ON — all permissions are skipped",
    "perm.autoApproveOffTip": "Click to auto-approve all permissions for this chat",
    ...
    "directors.empty": "No directors configured",
    "directors.emptyHint": "Create autonomous agents that work on schedules",
    "directors.create": "Create Director",
    "directors.createFromTemplate": "From template",
    "directors.enabled": "Enabled",
    "directors.disabled": "Disabled",
    "directors.schedule": "Schedule",
    ...
    "directors.deleteConfirm": "Delete director \"{name}\"?",
    "directors.never": "Never",
    "directors.queued": "Queued for execution",
    ...
    "directors.noActivity": "No recent activity",
    ...
    "projects.installTo": "Installing to: {name}",
    ...
    "projects.directors": "{count} directors",
  ...
  es: {
    ...
    "perm.autoApproveOffTip": "Click para auto-aprobar todos los permisos de este chat",
    ...
    "directors.empty": "No hay directores configurados",
    "directors.emptyHint": "Crea agentes autonomos que trabajen por horarios",
    "directors.create": "Crear Director",
    "directors.createFromTemplate": "Desde plantilla",
    "directors.enabled": "Activo",
    "directors.disabled": "Inactivo",
    "directors.schedule": "Horario",
    "directors.manual": "Manual",
    "directors.lastRun": "Ultima ejecucion",
    "directors.nextRun": "Proxima ejecucion",
    ...
    "directors.deleteConfirm": "Eliminar director \"{name}\"?",
    "directors.never": "Nunca",
    "directors.queued": "En cola para ejecucion",
    ...
    "directors.noActivity": "Sin actividad reciente",
    ...
    "projects.installTo": "Se instalará en: {name}",
    "projects.create": "Crear Proyecto",
    "projects.name": "Nombre del Proyecto",
    "projects.description": "Descripcion",
    "projects.color": "Color",
    "projects.teamTemplate": "Plantilla de Equipo",
    "projects.selectTemplate": "Selecciona una plantilla de equipo",
    "projects.emptyTemplate": "Vacio (sin directores)",
    "projects.delete": "Eliminar Proyecto",
    "projects.deleteConfirm": "Eliminar proyecto \"{name}\"? Se eliminaran todos los directores, tareas y entregables.",
    "projects.limitReached": "Maximo {max} proyectos alcanzado",
    "projects.directors": "{count} directores",
    "projects.switchTo": "Cambiar a {name}",

    // Inbox
    "inbox.title": "Bandeja",
    "inbox.empty": "No hay elementos en la bandeja",
    "inbox.emptyHint": "Los entregables de los directores apareceran aqui",
    "inbox.unread": "No leidos",
    "inbox.all": "Todos",
    ...
    "inbox.typeAnalysis": "Analisis",
    "inbox.typeCode": "Codigo",
    "inbox.typeNotification": "Notificacion",
    "inbox.statusUnread": "No leido",
    "inbox.statusRead": "Leido",
    "inbox.statusApproved": "Aprobado",
    "inbox.statusRejected": "Rechazado",
