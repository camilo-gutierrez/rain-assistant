...
export interface Director {
  ...
  permission_level: "green" | "yellow";
  can_delegate: boolean;
  context_window: Record<string, string>;
...
export interface InboxItem {
  ...
  title: string;
  content: string;
  content_type: "report" | "draft" | "analysis" | "code" | "notification";
  status: "unread" | "read" | "approved" | "rejected" | "archived";
  priority: number;
  task_id: string | null;
...
export interface ActivityItem {
  type: "director_run" | "inbox_item" | "task";
  director_id?: string;
  director_name?: string;
  emoji?: string;
  timestamp: number;
